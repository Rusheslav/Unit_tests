...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        // Проверка метода подсчета суммы со скидкой:
        assertThat(calculatingDiscount(10.0,20)).isEqualTo(8.0);
        assertThat(calculatingDiscount(0.0,40)).isEqualTo(0.0);
        assertThatThrownBy(() -> calculatingDiscount(180.0, -1))
                .isInstanceOf(ArithmeticException.class)
                .hasMessageContaining("Недопустимые аргументы");
        assertThatThrownBy(() -> calculatingDiscount(180.0, 120))
                .isInstanceOf(ArithmeticException.class)
                .hasMessageContaining("Недопустимые аргументы");
        assertThatThrownBy(() -> calculatingDiscount(-10.0, 20))
                .isInstanceOf(ArithmeticException.class)
                .hasMessageContaining("Недопустимые аргументы");
        assertThatThrownBy(() -> calculatingDiscount(-10.0, 120))
                .isInstanceOf(ArithmeticException.class)
                .hasMessageContaining("Недопустимые аргументы");
